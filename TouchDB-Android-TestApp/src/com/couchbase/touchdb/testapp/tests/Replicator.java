...
public class Replicator extends TouchDBTestCase {
    ...
    public void testPusher() throws Throwable {
        ...
        final TDReplicator repl = database.getReplicator(remote, true, false, -1, null, server.getWorkExecutor());
    ...
    public void testPuller() throws Throwable {
        ...
        final TDReplicator repl = database.getReplicator(remote, false, false, -1, null, server.getWorkExecutor());
        runTestOnUiThread(new Runnable() {
        ...
        final TDReplicator repl2 = database.getReplicator(remote, false, false, -1, null, server.getWorkExecutor());
        runTestOnUiThread(new Runnable() {
