...
public class TDDatabase extends Observable {
    ...
    public TDReplicator getReplicator(URL remote, boolean push, boolean continuous, int timeout, ReplicationCallback cb) {
    	TDReplicator replicator = getReplicator(remote, null, push, continuous, timeout, cb);

    	return replicator;
    }

    public TDReplicator getReplicator(URL remote, HttpClientFactory httpClientFactory, boolean push, boolean continuous, int timeout, ReplicationCallback cb) {
        TDReplicator result = getActiveReplicator(remote, push);
        if(result != null) {
            return result;
        }
        result = push ? new TDPusher(this, remote, continuous, timeout, cb, httpClientFactory) : new TDPuller(this, remote, continuous, timeout, cb, httpClientFactory);
